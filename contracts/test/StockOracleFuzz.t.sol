...
contract StockOracleFuzzTest is Test {
    ...
    function testFuzz_SwitchStrategy(bool usePyth) public {
        StockOracle.OracleStrategy strategy =
            usePyth ? StockOracle.OracleStrategy.PYTH : StockOracle.OracleStrategy.CUSTOM_RELAYER;
    ...
    function testFuzz_GetPrice_Pyth(string memory symbol, uint256 price, uint256 publishTime) public {
